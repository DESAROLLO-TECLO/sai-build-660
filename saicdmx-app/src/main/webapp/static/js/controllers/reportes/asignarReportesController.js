angular.module('siidfApp').controller('asignarReportesController', 
	...
	$scope.revertir = function(){
		showAlert.confirmacion($scope.mensajeModal("Los cambios se perderán, ¿Desea continuar?"),confirmacionFinal, $scope.object, cancelarFinal);
	};
	
	$scope.guardar = function(){
		showAlert.confirmacion($scope.mensajeModal("¿Está seguro de guardar esta configuración?"),confirmGuadar, $scope.object, confirmCancelar);
	};
