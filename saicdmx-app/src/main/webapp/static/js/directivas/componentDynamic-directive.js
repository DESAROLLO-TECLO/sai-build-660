...
app.directive('componente', function($compile,$document, growl,$rootScope,$timeout,reporteService) {
    return {
        ...
        link : function (scope, element, attrs){
        	...
        	scope.modelo = [{nombreLista : "Resultados"},{nombreLista : "*Seleccione", listado : []}];
		...
		return elemReturn;//return angular element
        	...
        	function dateLong(param){//dd/mm/yyyy HH:mm:ss
        		...
        		var elemReturn = `<div class="col-md-6">
							<div class="form-group"
								ng-class="{\'has-error\': (formDinamico.${param.cdParametro}.$invalid && formDinamico.${param.cdParametro}.$dirty) }">
								<label>${param.nbParametro}</label>
								<div class="input-group" datetimepicker options="dateTimeOptions"
        	...
        	function switcher(param){
        		...
        		var elemReturn = `<div class="col-md-6">
        					<div class="form-group"
        						ng-class="{\'has-error\': (formDinamico.${param.cdParametro}.$invalid && formDinamico.${param.cdParametro}.$dirty) }">
								<label for="${param.nbParametro}" class="labelCheck noneSelectedUser">${param.nbParametro}</label>
        	...
        	function listaDoble (param){
        		...
        		var elemReturn = `<div class="row">
        					<div class="col-md-12">
								<label for="${param.nbParametro}">Escriba una o más ${param.nbParametro} separadas por (${concatenacion}) :</label>
									<div class="input-group">
										<span class="input-group-addon"> <i
										class="fa fa-pencil"></i></span>
									<input class="form-control" type="text" size=\'50\'
									id="busquePrevia${param.idParamtro}" name="busquePrevia${param.idParamtro}" placeholder="Buscar... "
									ng-model="busquePrevia${param.idParamtro}" /> <span class="input-group-btn">
						...
						<div class="row">
							<div class="col-md-12">
								<dnd-lists col="col-md-5" max-height="25vh" model="modelo"
									...
									nb-labels="NOMBRE" flag-success="flag" required-list="false"
        	...
        	function createAditionalProperties(listProperties){
        		...
        		if(listProperties != null && listProperties.length > 0){
        			angular.forEach(listProperties, function(value, key) {
        				...
        				if(value.txValor == 'DIRECTIVESINVAL'){
        					aditionalProperties += value.propiedad.nbHtmlPropiedad +' ';
        				}else if(value.txValor != null || value.txValor != undefined){
