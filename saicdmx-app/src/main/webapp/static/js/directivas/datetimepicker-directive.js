                	...
                	$scope.$watch('idiomaDtp', function(lang) {
	                    ...
	                    dpElement.on('dp.change', function (e) {
	                        if (!isDateEqual(e.date, ngModel.$viewValue)) {
	                            ...
	                            if($scope.formatDateLong != undefined && $scope.formatDateLong && newValue != null){
	                            	//var dateShort = newValue.format('L');
	                            	var dateShort = newValue.format('DD/MM/YYYY');
	                            	var hourMinuteSecond =newValue.format("HH:mm:ss");
	                            	var dateLongformat = dateShort +' '+ hourMinuteSecond;
	                            	ngModel.$setViewValue(dateLongformat);//el modelo vendrá en formato dd/mm/yyyy hh:mm:ss
	                            }else{
