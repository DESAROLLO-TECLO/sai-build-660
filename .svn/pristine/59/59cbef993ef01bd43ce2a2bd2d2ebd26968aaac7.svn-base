angular.module('siidfApp').controller('consultaReportesController', function($window,$scope,ReporteDinamicosServices,ModalService,responsiveHelper,$location) {
