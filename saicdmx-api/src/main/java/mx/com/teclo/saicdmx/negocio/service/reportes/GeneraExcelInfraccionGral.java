...
@Service("GeneraExcelInfraccionGral")
public class GeneraExcelInfraccionGral {
	
	private ByteArrayOutputStream byteArrayOutputStream = null;
	private RutinasTiempoImpl rutinasTiempo;
	
	
	public ByteArrayOutputStream generarReporteExcel(List<ReporteInfraccionesGralVO> listaRegistros,String nombreReporte, String fechaInicio,  String fechaFin,String leyenda,String articulos ){
		...
		titulos.add("DÍA/HORA INFRACCIÓN");
		...
		subtitulos.add(leyenda +articulos);
		...
		for (ReporteInfraccionesGralVO Detalles : listaRegistros) {
			...
			listaContenido1.add(Detalles.getPLACA_EXPEDIDA());
