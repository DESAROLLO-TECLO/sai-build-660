...
public class AdminCajasNuevoSPVO {
	...
	public String getP_caja_cod() {
		return p_caja_cod;
	}
	public void setP_caja_cod(String p_caja_cod) {
		this.p_caja_cod = p_caja_cod;
	}
