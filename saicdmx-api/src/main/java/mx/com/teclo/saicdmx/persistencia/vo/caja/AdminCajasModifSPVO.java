...
public class AdminCajasModifSPVO {
	...
	public AdminCajasModifSPVO(String p_operacion, Long p_caja_id, Long p_caja_emp_id, Long p_modificado_por,
			String cd_aplicacion, Long p_resultado, String p_mensaje) {
		super();
