...
public class GarantiaGeneraReporteVoucherChip {
	
	  public ByteArrayOutputStream generaReporteVoucherChip(ArrayList arrVoucherComercio,
	            ArrayList arrVoucherCliente, String logoSSP, String logoPlaca, String sRutaChip) {
	        ...
	        try {
	           reporte.write(JasperRunManager.runReportToPdf(sRutaChip, p, new JREmptyDataSource()));
	        } catch (Exception e) {
