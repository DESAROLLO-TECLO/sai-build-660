...
@Service
public class BitTrBitUpInfracRadarImpl implements BitTrBitUpInfracRadar {
	...
	public ArrayList<BitacoraCambiosVO> guardarCambiosBitacora(RespuestaWSReasignaLineaCapturaVO newInfraccionVO,
		...
		if(!ComparaUtils.comparaCadenas(oldInfraccionVO.getInfracRadarVO().getFechaEmision(), newInfraccionVO.getInfracRadarVO().getFechaEmision())){
			BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
			bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
			bitacoraCambiosVO.setComponenteId(5L);
			bitacoraCambiosVO.setConceptoId(17L);
			bitacoraCambiosVO.setValorOriginal(oldInfraccionVO.getInfracRadarVO().getFechaEmision() != null ? oldInfraccionVO.getInfracRadarVO().getFechaEmision() : "");
			bitacoraCambiosVO.setValorFinal(newInfraccionVO.getInfracRadarVO().getFechaEmision() != null ? newInfraccionVO.getInfracRadarVO().getFechaEmision() : "");
			bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
			bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11));
			bitacoraCambiosVO.setOrigen(ParametrosBitacoraEnum.ORIGEN_W.getParametro());
			bitacoraCambiosVOs.add(bitacoraCambiosVO);
	  }
	  if(!ComparaUtils.comparaCadenas(oldInfraccionVO.getLineacaptura(), newInfraccionVO.getLineacaptura())){
		  	BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
			bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
			bitacoraCambiosVO.setComponenteId(5L);
			bitacoraCambiosVO.setConceptoId(49L);
			bitacoraCambiosVO.setValorOriginal(oldInfraccionVO.getLineacaptura() != null ? oldInfraccionVO.getLineacaptura() : "");
			bitacoraCambiosVO.setValorFinal(newInfraccionVO.getLineacaptura() != null ? newInfraccionVO.getLineacaptura() : "");
			bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
			bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno() != null && !newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().equals("")? newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11) : "");
			bitacoraCambiosVO.setOrigen(ParametrosBitacoraEnum.ORIGEN_W.getParametro());
			bitacoraCambiosVOs.add(bitacoraCambiosVO);
	  }
	  if(!ComparaUtils.comparaCadenas(oldInfraccionVO.getVigencia(), newInfraccionVO.getVigencia())){
		  
			DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
			DateFormat formatterBD = new SimpleDateFormat("dd/MM/yy");
			
			Date dateOldFecha = formatter.parse(oldInfraccionVO.getVigencia().substring(0,10));
			Date dateNewFecha = formatter.parse(newInfraccionVO.getVigencia().substring(0,10));
			
			String dateOldFechaFormat = formatterBD.format(dateOldFecha);
			String dateNewFechaFormat = formatterBD.format(dateNewFecha);

			if(!ComparaUtils.comparaCadenas(dateOldFechaFormat, dateNewFechaFormat)){
					
			  	BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
				bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
				bitacoraCambiosVO.setComponenteId(5L);
				bitacoraCambiosVO.setConceptoId(50L);
				bitacoraCambiosVO.setValorOriginal(dateOldFechaFormat);
				bitacoraCambiosVO.setValorFinal(dateNewFechaFormat);
				bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
				bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11));
	  ...
	  if(!ComparaUtils.comparaCadenas(oldInfraccionVO.getTotal(), newInfraccionVO.getTotal())){
		  	BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
			bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
			bitacoraCambiosVO.setComponenteId(5L);
			bitacoraCambiosVO.setConceptoId(51L);
			bitacoraCambiosVO.setValorOriginal(oldInfraccionVO.getTotal() != null ? oldInfraccionVO.getTotal() : "");
			bitacoraCambiosVO.setValorFinal(newInfraccionVO.getTotal() != null ? newInfraccionVO.getTotal() : "");
			bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
			bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11));
			bitacoraCambiosVO.setOrigen(ParametrosBitacoraEnum.ORIGEN_W.getParametro());
			bitacoraCambiosVOs.add(bitacoraCambiosVO);
	  ...
	  // para los casos de que valor inicial o final sea null 
	  if (ComparaUtils.cadenaNvl(oldInfraccionVO.getInfracRadarVO().getFechaEmision())==null && ComparaUtils.cadenaNvl(newInfraccionVO.getInfracRadarVO().getFechaEmision())!=null
	   || ComparaUtils.cadenaNvl(newInfraccionVO.getInfracRadarVO().getFechaEmision())==null && ComparaUtils.cadenaNvl(oldInfraccionVO.getInfracRadarVO().getFechaEmision())!=null) {
		  BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
		  bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
		  bitacoraCambiosVO.setComponenteId(5L);
		  bitacoraCambiosVO.setConceptoId(17L);
		  bitacoraCambiosVO.setValorOriginal(ComparaUtils.cadenaNvl(oldInfraccionVO.getInfracRadarVO().getFechaEmision()));
		  bitacoraCambiosVO.setValorFinal(ComparaUtils.cadenaNvl(newInfraccionVO.getInfracRadarVO().getFechaEmision()));
		  bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
		  bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11));
		  bitacoraCambiosVO.setOrigen(ParametrosBitacoraEnum.ORIGEN_W.getParametro());
		  bitacoraCambiosVOs.add(bitacoraCambiosVO);
	  }
	  if (ComparaUtils.cadenaNvl(oldInfraccionVO.getLineacaptura())==null && ComparaUtils.cadenaNvl(newInfraccionVO.getLineacaptura())!=null
	   || ComparaUtils.cadenaNvl(newInfraccionVO.getLineacaptura())==null && ComparaUtils.cadenaNvl(oldInfraccionVO.getLineacaptura())!=null) {
		  BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
		  bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
		  bitacoraCambiosVO.setComponenteId(5L);
		  bitacoraCambiosVO.setConceptoId(49L);
		  bitacoraCambiosVO.setValorOriginal(ComparaUtils.cadenaNvl(oldInfraccionVO.getLineacaptura()));
		  bitacoraCambiosVO.setValorFinal(ComparaUtils.cadenaNvl(newInfraccionVO.getLineacaptura()));
		  bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
		  bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11));
		  bitacoraCambiosVO.setOrigen(ParametrosBitacoraEnum.ORIGEN_W.getParametro());
		  bitacoraCambiosVOs.add(bitacoraCambiosVO);
	  }
	  if (ComparaUtils.cadenaNvl(oldInfraccionVO.getVigencia())==null && ComparaUtils.cadenaNvl(newInfraccionVO.getVigencia())!=null
	   || ComparaUtils.cadenaNvl(newInfraccionVO.getVigencia())==null && ComparaUtils.cadenaNvl(oldInfraccionVO.getVigencia())!=null) {
		  BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
		  bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
		  bitacoraCambiosVO.setComponenteId(5L);
		  bitacoraCambiosVO.setConceptoId(50L);
		  bitacoraCambiosVO.setValorOriginal(ComparaUtils.cadenaNvl(oldInfraccionVO.getVigencia()));
		  bitacoraCambiosVO.setValorFinal(ComparaUtils.cadenaNvl(newInfraccionVO.getVigencia()));
		  bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
		  bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11));
		  bitacoraCambiosVO.setOrigen(ParametrosBitacoraEnum.ORIGEN_W.getParametro());
		  bitacoraCambiosVOs.add(bitacoraCambiosVO);
	 }
	 if (ComparaUtils.cadenaNvl(oldInfraccionVO.getTotal())==null && ComparaUtils.cadenaNvl(newInfraccionVO.getTotal())!=null
	   || ComparaUtils.cadenaNvl(newInfraccionVO.getTotal())==null && ComparaUtils.cadenaNvl(oldInfraccionVO.getTotal())!=null) {
		  BitacoraCambiosVO bitacoraCambiosVO = new BitacoraCambiosVO();
		  bitacoraCambiosVO.setTable(ParametrosBitacoraEnum.TAI_BITACORA_CAMBIOS.getParametro());
		  bitacoraCambiosVO.setComponenteId(5L);
		  bitacoraCambiosVO.setConceptoId(51L);
		  bitacoraCambiosVO.setValorOriginal(ComparaUtils.cadenaNvl(oldInfraccionVO.getTotal()));
		  bitacoraCambiosVO.setValorFinal(ComparaUtils.cadenaNvl(newInfraccionVO.getTotal()));
		  bitacoraCambiosVO.setCreadoPor(newInfraccionVO.getUsuario() != null ? Long.parseLong(newInfraccionVO.getUsuario()):0L);
		  bitacoraCambiosVO.setIdRegistro(newInfraccionVO.getInfracRadarVO().getNumeroControlInterno().substring(0, 11));
		  bitacoraCambiosVO.setOrigen(ParametrosBitacoraEnum.ORIGEN_W.getParametro());
		  bitacoraCambiosVOs.add(bitacoraCambiosVO);
	  ...
	  if (!ComparaUtils.comparaCadenas(newInfraccionVO.getInfracRadarVO().getInfracObserveQueDesc(),oldInfraccionVO.getInfracRadarVO().getInfracObserveQueDesc())) {
		...
		// -- autorizado por siempre se debe guardar;  En el trigger de radares compara el que modifica sea diferente al anterior
